...
1. Before you can complete the ASU Authorized Driver Program, you first need to complete the EHS Authorized Driver Training module. To do this, go to this page [here](https://cfo.asu.edu/defensive-driving-training) and click on the 'Training access' tab all the way at the bottom. 
...
3. Follow the training instructions, and once the training is successfully completed you should see a green 'Completed' status indicator on the right side.
    ...
    **Note**: After completing the Authorized Driver Training, it may take up to 72 hours to reflect the completion date on your record.
...
4. After you have completed the above steps, you should get an invitation email from HireRight Customer Support to complete the motor vehicle record (MVR) check. Scroll down and click the 'Start Motor Vehicle Record Verification' button, and enter all necessary information for the MVR check.
    
    <img src="./screenshots/HireRight-initial-email.png" width=45% height=45%>   
    <img src="./screenshots/MVR-start.png" width=60% height=60%>

5. Once the MVR Verification has been submitted, you should get two different confirmation emails from HireRight. Save these in case there are any issues with getting your Driver Authorization completed. 

    <img src="./screenshots/email.png" width=90% height=90%>
